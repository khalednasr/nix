...
let
  ...
  customPackage =
    ...
    inputs.nixvim.legacyPackages."${pkgs.stdenv.hostPlatform.system}".makeNixvim {
      ...
      dependencies.yazi.package = self.packages."${pkgs.stdenv.hostPlatform.system}".yazi;
      ...
      keymaps = [
        ...
        # Add empty lines in normal mode
        {
          ...
          action = "o<ESC>";
          mode = [ "n" ];
          options.desc = "Add empty line below";
        }
        {
          key = "<leader>O";
          action = "O<ESC>";
          mode = [ "n" ];
          options.desc = "Add empty line above";
        }
        ...
        }
        {
          ...
          options.desc = "Delete into clipboard";
        }
        {
          key = "<leader>p";
          action = "\"+p";
          ...
          options.desc = "Paste from clipboard (after)";
        }
        {
          key = "<leader>P";
          action = "\"+P";
          ...
          options.desc = "Paste from clipboard (before)";
        }
        ...
        # File explorer and picker
        {
          ...
          options.desc = "Yazi at current buffer";
        }
        {
          key = "<leader>E";
        ...
        }
        {
          ...
          mode = [ "n" ];
          options.desc = "Search file diagnostics";
        }
        {
          key = "<leader>sc";
        ...
        # REPL
        {
          ...
          options.desc = "REPL Config";
        }
        {
          key = "<leader>rr";
          action = "<Plug>SlimeCellsSendAndGoToNext";
          options.desc = "REPL send cell and go to next";
        }
        {
          key = "<leader>rR";
          action = "<Plug>SlimeSendCell";
          options.desc = "RELP send cell";
        }
        {
          key = "<leader>rl";
          action = "<Plug>SlimeLineSend";
          options.desc = "REPL send line";
        }
        {
          key = "<leader>rm";
          action = "<Plug>SlimeMotionSend";
          options.desc = "REPL send motion";
        }
        {
          key = "<leader>rr";
          action = ":<C-u>'<;'>SlimeSend<CR>";
          mode = "v";
          options.desc = "REPL send selection";
        }
        {
          key = "<leader>rj";
          action = "<Plug>SlimeCellsNext";
          options.desc = "REPL go to next cell";
        }
        {
          key = "<leader>rk";
          action = "<Plug>SlimeCellsPrev";
          options.desc = "REPL go to previous cell";
        }
